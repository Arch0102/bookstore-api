...
public class GlobalExceptionHandler {
    ...
    public ApiErrorResponse handleUnauthorizedAccess(UnauthorizedAccessException ex,
                                                     HttpServletRequest request) {
        return ApiErrorResponse.of(403, ex.getMessage(),
                List.of(ex.getMessage()), request.getRequestURI());
    }

    @ExceptionHandler(InvalidOrderStateException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ApiErrorResponse handleInvalidOrderState(InvalidOrderStateException ex,
                                                    HttpServletRequest request) {
        return ApiErrorResponse.of(409, ex.getMessage(),
                List.of(ex.getMessage()), request.getRequestURI());
    }
    ...
    @ResponseStatus(HttpStatus.CONFLICT)
    public ApiErrorResponse handleAuthorHasBooks(AuthorHasBooksException ex,
                                                 HttpServletRequest request) {
        return ApiErrorResponse.of(409, ex.getMessage(),
                List.of(ex.getMessage()), request.getRequestURI());
    }
    ...
    public ApiErrorResponse handleAccessDenied(AccessDeniedException ex,
        ...
        return ApiErrorResponse.of(403, "No tiene permisos para esta operación",
                List.of("No tiene permisos para esta operación"), request.getRequestURI());
    }
    ...
    public ApiErrorResponse handleAuthentication(AuthenticationException ex,
        ...
        return ApiErrorResponse.of(401, "Autenticación requerida",
                List.of("Autenticación requerida"), request.getRequestURI());
    }
